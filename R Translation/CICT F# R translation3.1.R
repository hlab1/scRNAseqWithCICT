...
n.itm.v.trgtsum = n.itm.v%>% left_join(n.itm.e,by=c("vID"="src")) %>%
  group_by(vID) %>% summarise(SumOcrInp.y=sum(OcrInp.x,na.rm=TRUE),
                              SumOcrOut.y=sum(OcrOut.x,na.rm=TRUE))
...
n.itm.v = n.itm.v %>% left_join(others,by=c("vID"="src"))
...
#   TODO Enhance edges conf contrib -----


#   TODO  Add Power parameters to vertices and edges ----
#all the power input from different sources to each trgt
  #powerParamsIn=
#  TODO check histogram of new variables -----

#TODO    Add BA factors and combined measures -----
#TODO   check histogram of specific Edges or parameters -----

#TODO   Add transparency -----
#TODO   Enhance vertices influx outflux----

#TODO   Enhance vertices Add moments of  contribution ----


#TODO   Enhance vertices Add moments of Confidence and contribution ----


#TODO   Integrating moments with n.itm.v -----
...
#TODO   Add TZ factors Edge causality indices  -----
